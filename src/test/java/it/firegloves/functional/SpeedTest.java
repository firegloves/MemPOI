...
import it.firegloves.domain.footer.StandardMempoiFooter;
import it.firegloves.exception.MempoiException;
import it.firegloves.styles.template.ForestStyleTemplate;
import it.firegloves.styles.template.StoneStyleTemplate;
import it.firegloves.styles.template.SummerStyleTemplate;
