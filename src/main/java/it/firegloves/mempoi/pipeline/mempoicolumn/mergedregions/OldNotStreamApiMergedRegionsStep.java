...
public class OldNotStreamApiMergedRegionsStep<T> implements MempoiColumnElaborationStep<T> {
    ...
    public OldNotStreamApiMergedRegionsStep(CellStyle cellStyle, int mempoiColumnIndex) {
